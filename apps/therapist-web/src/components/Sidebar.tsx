...
const navItems = [
  ...
  { id: 'patients', href: '/patients', label: 'Pacientes', icon: Users },
  { id: 'clinical-notes', href: '/clinical-notes', label: 'Historia Clínica', icon: FileText },
]
      ...
      <div className="border-b border-white/10 px-6 py-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/40">Psicología Clínica</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="truncate text-xs font-semibold text-white">Dr. Carlos Mendez</p>
            <p className="text-xs text-white/40">Terapeuta</p>
          </div>
        </div>
      </div>
